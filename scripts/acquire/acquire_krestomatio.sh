...
python scripts/acquire/acquire_krestomatio.py 2>&1 | tee "$LOG_FILE"

echo ""
echo "✓ Acquisition complete!"
echo ""
echo "Next steps:"
echo "  1. Clean: python scripts/clean/clean_gutenberg.py --input data/raw/eo/gutenberg --output data/cleaned/eo/tier0"
echo "  2. Extract: python scripts/extract/extract_tier0_literary.py"
