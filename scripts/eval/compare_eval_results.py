...
VERSION: v2.1
COMPATIBLE WITH: scripts/eval/evaluate_extractive_qa.py output format
...
Usage:
    python scripts/eval/compare_eval_results.py BASELINE.json NEW.json
    python scripts/eval/compare_eval_results.py --label-baseline "old" \\
                                           --label-new      "new" \\
