...
Description:
    Runs the same per-question logic as scripts/eval/evaluate_extractive_qa.py,
...
Usage:
    ...
    modal run scripts/eval/modal_eval.py \\
    ...
    modal run scripts/eval/modal_eval.py --limit 3
...
See Also: scripts/eval/evaluate_extractive_qa.py, scripts/eval/modal_upload_indexes.sh
"""
