...
run_extraction "scripts/extract/extract_tier0_literary.sh" "Literary works (Gutenberg + Fundamento)"

# 2. Grammar works (authoritative references)
run_extraction "scripts/extract/extract_grammar_works.sh" "Grammar works (PMEG, PAG, Lingvaj Respondoj)"

# 3. Proverbaro (scanned, may have OCR issues)
run_extraction "scripts/extract/extract_proverbaro.sh" "Proverbaro Esperanta (proverbs)"
