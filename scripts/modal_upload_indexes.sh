...
#
# Usage:
#   ./scripts/modal_upload_indexes.sh           # upload both
#   ./scripts/modal_upload_indexes.sh kuzu      # only Kuzu
#   ./scripts/modal_upload_indexes.sh whoosh    # only Whoosh
...
echo "  modal run scripts/modal_eval.py \\"
